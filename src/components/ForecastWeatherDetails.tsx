      ...
      <div className="flex items-center gap-6 md:gap-10">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="text-xs text-white/50">
            Feels like{' '}
            {isCelsius ? convertKtoC(feels_like ?? 273.15) : convertKtoF(feels_like ?? 273.15)}°
          </p>
          <p className="flex gap-2 text-xs text-white/50 justify-center sm:justify-start">
            <span>H: {isCelsius ? convertKtoC(temp_max) : convertKtoF(temp_max)}°</span>
            <span>L: {isCelsius ? convertKtoC(temp_min) : convertKtoF(temp_min)}°</span>
          </p>
        </div>
      </div>
